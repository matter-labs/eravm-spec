...
Section Defs.
  ...
  Inductive code_fetch: depot -> code_storage
                        -> contract_address -> (versioned_hash *code_page * code_length) -> Prop :=
  | cfh_load : forall (contracts:depot) (called_address:contract_address) deployer_storage hash_enc (code_storage:code_storage) code_length_in_words extra_marker partial_hash page_init,
