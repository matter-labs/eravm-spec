...
Inductive step: instruction -> smallstep :=
  ...
  | step_Div_no_overflow:
    forall codes flags depot pages xstack context_u128 regs (arg_op1:in_any) (arg_op2:in_reg) (arg_out1:out_any) (arg_out2:out_reg) any_tag1 any_tag2 mod_swap mod_flags (x y:Z) new_regs new_xstack new_pages new_flags quot rem,
      ...
      step (OpDiv arg_op1 arg_op2 arg_out1 arg_out2 mod_swap mod_flags)
        ...
        |}
  | step_Div_overflow:
    forall codes flags depot pages xstack context_u128 regs (arg_op1:in_any) (arg_op2:in_reg) (arg_out1:out_any) (arg_out2:out_reg) any_tag1 any_tag2 mod_swap mod_flags (x y:Z) new_regs new_xstack new_pages new_flags,
      fetch_apply22_swap mod_swap (regs,xstack,pages)
                     arg_op1 arg_op2
                     arg_out1 arg_out2
