...
*)
| step_RetExt_heapvar:
  forall pages cf caller_stack cs1 new_caller enc  ___ ____ _____ out_ptr heap_type hspan params s1 s2,
  ...
  forall pages cf caller_stack cs1 new_caller __ ___ ____ in_ptr out_ptr page params enc s1 s2,
    let cs0 := ExternalCall cf (Some caller_stack) in
